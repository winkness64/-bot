...
class MemoryRetriever:
    ...
    def render_prompt_section(
        ...
        格式：
        [来自长期记忆的事实]
        说明：以下记忆描述的是当前用户/对话对象，不是助手自己的经历；回答用户关于自己偏好/习惯/信息的问题时，请用“你/用户/对方/阿漂”等用户主语，不要改成“我”；不确定时可说“记忆里显示/你之前说过”，不要猜。
        ...
        subject_guard = (
            ...
            "回答用户关于自己偏好/习惯/信息的问题时，请用“你/用户/对方/阿漂”等用户主语，不要改成“我”；"
            "不确定时可说“记忆里显示/你之前说过”，不要猜。"
        )
        compact_subject_guard = "说明：记忆描述当前用户，不是助手经历；回答偏好/习惯/信息用“你/用户/阿漂”，不要说成“我”；不确定说“你之前说过”。"
        minimal_subject_guard = "说明：记忆是当前用户的，不是助手经历；用“你/阿漂”，不要说“我”。"
        ...
        if has_self_memory_query:
            disambiguation_guard = (
                ...
                "请直接根据记忆用“你/阿漂”等用户主语回答，不要反问“是在问我吗”；"
                "只有明确说“你喜欢/你喝/你玩...”时，才理解为询问助手偏好。"
            )
            compact_disambiguation_guard = (
                "第一人称问句约束：用户问“我喜欢/我平时/我晚上...什么”是在问自己的记忆；"
                "直接用“你/阿漂”回答，不要反问“是在问我吗”。"
            )
            minimal_disambiguation_guard = "第一人称问句约束：这是用户在问自己的记忆；用“你/阿漂”直接回答，不要反问是不是问助手。"
            guards = (
